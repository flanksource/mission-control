module github.com/flanksource/kopper/hack/generate-schemas
...
require (
	...
	github.com/flanksource/duty v1.0.161 // indirect
	github.com/flanksource/gomplate/v3 v3.20.11 // indirect
