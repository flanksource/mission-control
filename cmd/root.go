...
func ServerFlags(flags *pflag.FlagSet) {
	...
	flags.StringVar(&api.PostgrestURI, "postgrest-uri", "http://localhost:3000", "URL for the PostgREST instance to use. If localhost is supplied, a PostgREST instance will be started")
