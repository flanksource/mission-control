...
//
// These are events that can also be generated by the application from the sync consumers
// or they could be generated from the database itself.
const (
...
var asyncConsumerWatchEvents = map[string][]string{
	...
	"responder":         {EventJiraResponderAdded, EventJiraCommentAdded},
}
