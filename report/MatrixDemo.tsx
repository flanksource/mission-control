        ...
        return (
          <MatrixTable
            ...
            rows={[
              ...
              {
                label: <UserLabel name="oipa-qa-bot" userId="bot-oipa-qa" />,
                cells: [null, null, <Cell direct={true} />, null, null, null, null],
              },
              {
                label: <UserLabel name="SG-OMAR Shared Developer" userId="sg-omar-dev" roleSource="group:omar-dev" />,
                cells: [null, <Cell direct={false} />, null, null, <Cell direct={false} />, null, null],
              },
              {
                label: <UserLabel name="SG-OMAR Shared Read Only" userId="sg-omar-ro" roleSource="group:omar-ro" />,
