// Database <Select> shared by Postgres plugin tabs. Loads the
...
export interface DatabasePickerProps {
  ...
  // Some tabs use an empty value to mean "all databases"; others use it
  // for the connection's default database.
  emptyLabel: string;
  className?: string;
  disabled?: boolean;
}
